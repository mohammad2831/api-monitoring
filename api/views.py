...
class ApiView(APIView):
    def post(self,request):
        ...
        if data.is_valid():
            ...
            #print(api_url, interval_minutes)
            #send_request(api=api_url, interval_minutes=interval_minutes)

            send_request.delay(api_url, interval_minutes)
